...
from street_fighter_custom_wrapper_prior import StreetFighterCustomWrapper_prior

RESET_ROUND = True  # Whether to reset the round when fight is over. 
RENDERING = True    # Whether to render the game screen.

MODEL_NAME = r"ppo_ryu_prior_1500000_steps" # Specify the model file to load. Model "ppo_ryu_2500000_steps_updated" is capable of beating the final stage (Bison) of the game.
...
MODEL_DIR = r"trained_models_prior/"
...
def make_env(game, state):
    def _init():
        ...
        env = StreetFighterCustomWrapper_prior(env, reset_round=RESET_ROUND, rendering=RENDERING)
        return env
    return _init
