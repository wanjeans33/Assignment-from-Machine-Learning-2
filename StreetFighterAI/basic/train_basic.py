...
from street_fighter_custom_wrapper_basic import StreetFighterCustomWrapper
...
def main():
    ...
    save_dir = "trained_models_basic"
    os.makedirs(save_dir, exist_ok=True)

    checkpoint_interval = 31250 # checkpoint_interval * num_envs = total_steps_per_checkpoint
    checkpoint_callback = CheckpointCallback(save_freq=checkpoint_interval, save_path=save_dir, name_prefix="ppo_ryu_basic")
